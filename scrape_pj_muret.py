...
then match results with api_muret.json entries.
"""
...
SEARCHES = [
    ("garage automobile", "garage+automobile", "muret+31"),
    ("concession automobile", "concession+automobile", "muret+31"),
    ("carrosserie automobile", "carrosserie+automobile", "muret+31"),
    ("concession moto", "concession+moto", "muret+31"),
    ("garage moto", "garage+moto", "muret+31"),
]

PJ_CACHE_FILE = "/home/user/Website01/pj_cache_muret.json"
OUTPUT_FILE = "/home/user/Website01/pj_results_muret.json"
ENRICHED_FILE = "/home/user/Website01/enriched_muret_pj.json"
SOURCE_FILE = "/home/user/Website01/api_muret.json"
