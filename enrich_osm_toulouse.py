#!/usr/bin/env python3
"""
Enrichit les entreprises automobiles de Toulouse avec des données OpenStreetMap (Overpass API).
Fait du fuzzy matching entre les résultats OSM et le fichier api_toulouse.json.
"""
...
INPUT_FILE = "/home/user/Website01/api_toulouse.json"
OUTPUT_FILE = "/home/user/Website01/osm_toulouse.json"
...
(
  ...
  way["craft"="coachbuilder"](area.a);
  node["amenity"="car_rental"](area.a);
  way["amenity"="car_rental"](area.a);
);
out body;
"""
...
def normalize(name):
    """Normalise un nom pour le matching : minuscules, sans ponctuation, mots triés."""
    if not name:
        return ""
    name = name.lower()
