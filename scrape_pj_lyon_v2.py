#!/usr/bin/env python3
"""
Scrape Pages Jaunes by category for Lyon area businesses,
then match results with split_lyon.json entries.
"""
...
SEARCHES = [
    ("garage automobile", "garage+automobile", "lyon+33"),
    ("concession automobile", "concession+automobile", "lyon+33"),
    ("carrosserie automobile", "carrosserie+automobile", "lyon+33"),
    ("concession moto", "concession+moto", "lyon+33"),
    ("garage moto", "garage+moto", "lyon+33"),
]

PJ_CACHE_FILE = "/home/user/Website01/pj_cache_lyon.json"
OUTPUT_FILE = "/home/user/Website01/pj_results_lyon.json"
ENRICHED_FILE = "/home/user/Website01/enriched_lyon_pj.json"
SOURCE_FILE = "/home/user/Website01/split_lyon.json"
...
def main():
    print("=" * 60)
    print("Pages Jaunes Scraper - Lyon Auto Businesses")
    print("=" * 60)
