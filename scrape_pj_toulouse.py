...
then match results with api_toulouse.json entries.
"""
...
SEARCHES = [
    ("garage automobile", "garage+automobile", "toulouse+31"),
    ("concession automobile", "concession+automobile", "toulouse+31"),
    ("carrosserie automobile", "carrosserie+automobile", "toulouse+31"),
    ("concession moto", "concession+moto", "toulouse+31"),
    ("garage moto", "garage+moto", "toulouse+31"),
]

PJ_CACHE_FILE = "/home/user/Website01/pj_cache_toulouse.json"
OUTPUT_FILE = "/home/user/Website01/pj_results_toulouse.json"
ENRICHED_FILE = "/home/user/Website01/enriched_toulouse_pj.json"
SOURCE_FILE = "/home/user/Website01/api_toulouse.json"
