#!/usr/bin/env python3
"""
Scrape Pages Jaunes for BTP Tous Corps d'État companies, enrich with SIRET,
and export to formatted Excel.

Usage:
    python3 build_btp_tce.py                    # Full pipeline (all departments)
    python3 build_btp_tce.py scrape 69          # Scrape one department only
    python3 build_btp_tce.py scrape 69 33 77    # Scrape specific departments
    python3 build_btp_tce.py export             # SIRET enrichment + Excel export

Output: pagesjaunes_btp_tce_france.xlsx
"""
...
CACHE_DIR = "pagesjaunes_btp_cache"
SIRET_CACHE_FILE = "btp_siret_cache.json"
OUTPUT_FILE = "pagesjaunes_btp_tce_france.xlsx"
...
# =============================================================================
# Phone & Address parsing (from scrape_pagesjaunes_garages.py)
# =============================================================================
...
def extract_postal_city(address_text):
    ...
    if match:
        ...
        # Clean "Site web" that sometimes gets appended
...
# =============================================================================
# HTML Parsing (from scrape_pagesjaunes_garages.py)
# =============================================================================
...
def scrape_department(dept_num, session, query="BTP tous corps d'état"):
...
# =============================================================================
# SIRET Enrichment (from export_pj_garages_with_siret.py)
# =============================================================================
...
def load_all_btp_data():
    """Load all BTP data from cached JSON files and add metadata."""
    all_companies = []
...
def write_excel(companies, filename):
    ...
    summary = [
        ...
        ("Total entreprises BTP TCE", len(companies)),
...
def do_scrape(dept_list):
    """Phase 1: Scrape Pages Jaunes for BTP TCE companies."""
    print("=" * 70)
    print("  SCRAPING PAGES JAUNES — BTP TOUS CORPS D'ÉTAT")
...
def do_export():
    ...
    print("=" * 70)
    print("  EXPORT BTP TCE → EXCEL + SIRET")
    print("=" * 70)

    # Load all cached data
    print("\nChargement des données...")
    companies = load_all_btp_data()
    total = len(companies)
    ...
    print(f"  RÉSUMÉ")
    print(f"{'=' * 70}")
    print(f"  Total entreprises BTP TCE: {total:,}")
...
def main():
    ...
    if not args:
        ...
        print("Usage:")
        print("  python3 build_btp_tce.py              # Pipeline complet")
        print("  python3 build_btp_tce.py scrape 69     # Scrape dept 69")
        print("  python3 build_btp_tce.py export        # Export Excel + SIRET")
        sys.exit(1)
