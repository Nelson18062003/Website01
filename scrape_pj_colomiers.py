...
then match results with api_colomiers.json entries.
"""
...
SEARCHES = [
    ("garage automobile", "garage+automobile", "colomiers+31"),
    ("concession automobile", "concession+automobile", "colomiers+31"),
    ("carrosserie automobile", "carrosserie+automobile", "colomiers+31"),
    ("concession moto", "concession+moto", "colomiers+31"),
    ("garage moto", "garage+moto", "colomiers+31"),
]

PJ_CACHE_FILE = "/home/user/Website01/pj_cache_colomiers.json"
OUTPUT_FILE = "/home/user/Website01/pj_results_colomiers.json"
ENRICHED_FILE = "/home/user/Website01/enriched_colomiers_pj.json"
SOURCE_FILE = "/home/user/Website01/api_colomiers.json"
