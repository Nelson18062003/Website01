...
then match results with api_evry.json entries.
"""
...
SEARCHES = [
    ("garage automobile", "garage+automobile", "evry+91"),
    ("concession automobile", "concession+automobile", "evry+91"),
    ("carrosserie automobile", "carrosserie+automobile", "evry+91"),
    ("concession moto", "concession+moto", "evry+91"),
    ("garage moto", "garage+moto", "evry+91"),
]

PJ_CACHE_FILE = "/home/user/Website01/pj_cache_evry.json"
OUTPUT_FILE = "/home/user/Website01/pj_results_evry.json"
ENRICHED_FILE = "/home/user/Website01/enriched_evry_pj.json"
SOURCE_FILE = "/home/user/Website01/api_evry.json"
