#!/usr/bin/env python3
"""Fourth pass - fill remaining gaps."""
...
QUERIES = [
    # Still missing from previous passes
    ("garage", "45.20A", "93", 2),
    ("garage", "45.20A", "93", 5),
    ("garage", "45.20A", "93", 7),
    ("garage", "45.20A", "93", 8),
    ...
    ("automobile", "45.20A", "93", 4),
    ("automobile", "45.20A", "93", 5),
    ("automobile", "45.11Z", "54", 3),
    ("automobile", "45.11Z", "54", 4),
    ("automobile", "45.11Z", "54", 5),
    ("automobile", "45.11Z", "93", 2),
    ("automobile", "45.11Z", "93", 4),
    ("automobile", "45.11Z", "93", 5),
    ("automobile", "45.11Z", "93", 6),
    # 45.20B searches
    ("automobile", "45.20B", "54", 1),
    ("automobile", "45.20B", "93", 1),
    ("auto", "45.20B", "54", 1),
    ("auto", "45.20B", "93", 1),
]
