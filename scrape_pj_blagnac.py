...
then match results with api_blagnac.json entries.
"""
...
SEARCHES = [
    ("garage automobile", "garage+automobile", "blagnac+31"),
    ("concession automobile", "concession+automobile", "blagnac+31"),
    ("carrosserie automobile", "carrosserie+automobile", "blagnac+31"),
    ("concession moto", "concession+moto", "blagnac+31"),
    ("garage moto", "garage+moto", "blagnac+31"),
]

PJ_CACHE_FILE = "/home/user/Website01/pj_cache_blagnac.json"
OUTPUT_FILE = "/home/user/Website01/pj_results_blagnac.json"
ENRICHED_FILE = "/home/user/Website01/enriched_blagnac_pj.json"
SOURCE_FILE = "/home/user/Website01/api_blagnac.json"
