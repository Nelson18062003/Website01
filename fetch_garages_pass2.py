#!/usr/bin/env python3
"""Second pass - fetch remaining garage data that was rate-limited in pass 1."""
...
# Queries that failed or were incomplete in pass 1
QUERIES = [
    # Dept 54 garage 45.20A - pages 2-6 (page 1 got through)
    ("garage", "45.20A", "54", 2),
    ("garage", "45.20A", "54", 3),
    ("garage", "45.20A", "54", 4),
    ("garage", "45.20A", "54", 5),
    ("garage", "45.20A", "54", 6),
    # Dept 54 garage 45.11Z - all pages failed
    ("garage", "45.11Z", "54", 1),
    ("garage", "45.11Z", "54", 2),
    ("garage", "45.11Z", "54", 3),
    # Dept 93 garage 45.20A - all pages failed
    ("garage", "45.20A", "93", 1),
    ("garage", "45.20A", "93", 2),
    ("garage", "45.20A", "93", 3),
    ("garage", "45.20A", "93", 4),
    ("garage", "45.20A", "93", 5),
    # Dept 93 garage 45.11Z - failed
    ("garage", "45.11Z", "93", 1),
    ("garage", "45.11Z", "93", 2),
    ("garage", "45.11Z", "93", 3),
    # Dept 93 carrosserie page 4-5
    ("carrosserie", "45.20A", "93", 4),
    ("carrosserie", "45.20A", "93", 5),
    # Broad queries that failed
]

BROAD_QUERIES = [
    ("garage automobile", "54", 1),
    ("garage automobile", "54", 2),
    ("garage automobile", "54", 3),
    ("réparation automobile", "93", 1),
    ("réparation automobile", "93", 2),
    ("garage automobile", "93", 2),
]
...
def main():
    ...
    for q, dept, page in BROAD_QUERIES:
        encoded_q = urllib.parse.quote(q)
